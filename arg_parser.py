...
class ArgParser(ArgumentParser):
    def __init__(self):
        ...
        self.add_argument("-p", "--parse", action="store_true", default=False, help="Parse all mp3 file")
        ...
        self.add_argument("-f", "--file", action="store", nargs=1, help="Write here absolute path to your mp3 file")
